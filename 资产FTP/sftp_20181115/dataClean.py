...
def appendData(today, todayStr):
    if today.day < 21:
        ...
        if today.day == 1:
            ...
            elif os.path.exists(srcPath + 'DB2_POSL_APMS_LOGINFO_' + todayStr + '.csv'):
                shutil.copyfile(srcPath + 'DB2_POSL_APMS_LOGINFO_' + todayStr + '.csv', aimPath + 'APMS_LOGINFO' + endDayStr + '.csv')
    ...
    date2 = today + datetime.timedelta(days=addDay)
    loanEndDayStr = date2.strftime("%Y%m%d")
