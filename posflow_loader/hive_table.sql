...
PARTITIONED BY ( p_branch STRING COMMENT '分公司分区', p_date INT COMMENT '日期分区')
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
STORED AS TEXTFILE;


LOAD DATA LOCAL INPATH '/home/testFolder/logflow/zc_821_20181102/20181102_loginfo_rsp.txt' INTO TABLE rds_posflow.t1_trxrecprd_v2_tmp PARTITION ( p_branch='', p_date = '' );